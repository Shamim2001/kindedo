                        ...
                        <div class="col-5">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Enter slide name" value="{{ old('name') }}">
                        ...
                        <div class="col-5">
                            <div class="form-floating">
                                <select class="form-select" name="location" id="location"
                                    ...
                                    <option value="main_menu" {{ old('location') == 'main_menu' ? 'selected' : '' }}>Main
                                        Menu
                                    </option>
                                    <option value="footer_menu" {{ old('location') == 'footer_menu' ? 'selected' : '' }}>
                                        Footer Menu
                                    </option>
                                </select>
                        ...
                        <div class="col-2">
                            <div class="form-check form-switch form-switch-dark">
                                ...
                                <input class="form-check-input" type="checkbox" role="switch" id="SwitchCheck7"
                                    name="status" checked="checked" value="active">
                            ...
                            <div id="custom_menu">
                                <div class="mb-3">
                                    ...
                                    <div class="list-group col nested-list nested-sortable-handle" id="menu_item_box">
                                        ...
                                        {{-- first Row --}}
                                        <div class="list-group-item nested-1 menu_item" id="row1"
                                            style="display: block">
                                            <i class="ri-drag-move-fill align-bottom handle"></i>
                                            <div class="row g-2">
                                                <div class="col-6 menu_item_box">
                                                    <div class="form-floating mb-2">
                                                        <input type="text" class="form-control menu_title"
                                                            id="menu-title-1" Title name="menu_title[]"
                                                            value="{{ old('menu-title.1') }}"
                                                            placeholder="Enter menu title">
                                                        <label for="menu-title-0">Title</label>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control menu_url" id="menu-url-1"
                                                            name="menu_url[]" value="{{ old('menu-url.1') }}"
                                                            placeholder="Enter menu url">
                                                        <label for="menu-url-1">Url</label>
                                                    </div>
                                                </div>
