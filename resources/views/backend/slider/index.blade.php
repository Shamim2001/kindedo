...
@section('content')
    ...
    <div class="text-end mb-3">
        ...
        <a href="{{ route('slider.create') }}" class="btn btn-dark">Add New</a>
    </div>
        ...
        <tbody>
            @forelse ($sliders as $key => $slider)
                <tr>
                    ...
                    <td style="width: 10%">
                        <img src="{{ getAssetUrl($slider->image, 'uploads/sliders') }}" alt="" class="avatar-sm">
                    </td>
                    ...
                    <td style="width: 10%" class="text-center">
                        <div class="hstack gap-3 flex-wrap justify-content-center">
                            ...
                            <a data-bs-toggle="tooltip" data-bs-custom-class="danger-tooltip" data-bs-placement="top"
                                ...
                                onclick="deleteRecord({{ $slider->id }})"
