...
@section('content')
    ...
    <table class="table table-bordered align-middle">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 15%" class="text-center">
                        <div class="hstack gap-3 flex-wrap justify-content-center">
                            ...
                            <a href="{{ route('category.edit', $category->id) }}" class="btn btn-outline-primary btn-icon btn-sm cursor-pointer"><i
                            ...
                            <form id="delete-form-{{ $category->id }}" action="{{ route('category.destroy', $category) }}"
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center">No category(s) found!</td>
                </tr>
            @endforelse
