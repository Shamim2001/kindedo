    ...
    @if ($abouts)
        ...
        <section class="bd-testimonial-area-2 pb-120 p-relative pt-120 theme-bg">
            <div class="bd-testimonial-bottom-shape">
                <img src="{{ asset('frontend') }}/assets/img/shape/wave-section-break.png" alt="img not found!">
            </div>
            <div class="container">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="bd-testimonial-2 mr-5 theme-bg-6 mb-25">
                                        ...
                                        <div class="bd-testimonial-content-2 mb-35">
                                            <p>Happy Christmas to the whole Kindedo from everyone at Monkton. A big
                                                thank
                                                you to
                                                Kindedo pupil Will who lent his Kindedo to this card, it's very usefull
                                                for
                                        ...
                                        <div class="bd-testimonial-avatar d-flex align-items-center">
                                            <div class="bd-testimonial-avatar-thumb">
                                                <img src="{{ asset('frontend') }}/assets/img/testimonials/1.png"
                                ...
                                <div class="swiper-slide">
                                    <div class="bd-testimonial-2 mr-5 clr-3 theme-bg-7">
                                        ...
                                        <div class="bd-testimonial-content-2 mb-35">
                                            <p>Your child will laugh, play and explore at Summer at MLS. From soccer,
                                                water
                                                play, art, music, theater and science, Shabbat celebrations, cooking,
                                                they
                                                will love
                                        ...
                                        <div class="bd-testimonial-avatar d-flex align-items-center">
                                            <div class="bd-testimonial-avatar-thumb">
                                                <img src="{{ asset('frontend') }}/assets/img/testimonials/2.png"
                                                    alt="testimonial avatar">
                                            </div>
                                        ...
                                        <div class="bd-teacher">
                                            ...
                                            <div class="bd-teacher-content-wrapper">
                                                <div class="bd-teacher-content">
                                                    ...
                                                    <span
                                                        class="bd-teacher-des text-capitalize">{{ $teacher->role }}</span>
                                                </div>
