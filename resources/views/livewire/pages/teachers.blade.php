                    ...
                    <div class="bd-teacher mb-40 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <a href="teacher-details.html">
                            <div class="bd-teacher-thumb">
                                <img src="{{ getAssetUrl($item->photo, 'teachers') }}" alt="{{ $item->name }}">
                            </div>
                        </a>
                        <div class="bd-teacher-content-wrapper">
                            <div class="bd-teacher-content">
                                <h4 class="bd-teacher-title"><a href="teacher-details.html">{{ $item->name }}</a></h4>
                                <span class="bd-teacher-des text-capitalize">{{ $item->role }}</span>
                            </div>
