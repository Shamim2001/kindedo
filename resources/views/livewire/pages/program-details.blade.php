                    ...
                    <div class="col-xl-10">
                        <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                            <div class="bd-breadcrumb-content text-center">
                                <h1 class="bd-breadcrumb-title">Programs Details</h1>
                                <div class="bd-breadcrumb-list">
                                    <span><a href="{{ route('front.index') }}"><i
                                                class="flaticon-hut"></i>Kindedo</a></span>
            ...
            <div class="row">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="bd-program-details-slider-thumb">
                                        <img src="{{ asset('frontend') }}/assets/img/program/home-program-1.jpg" alt="img not found!">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="bd-program-details-slider-thumb">
                                        <img src="{{ asset('frontend') }}/assets/img/program/home-program-2.jpg" alt="img not found!">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="bd-program-details-slider-thumb">
                                        <img src="{{ asset('frontend') }}/assets/img/program/home-program-3.jpg" alt="img not found!">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-12 mb-50">
                    <div class="bd-program-details-widget-content theme-bg-6 wow fadeInRight" data-wow-duration="1s"
                        data-wow-delay=".3s">
                        <h3 class="bd-program-details-widget-title mb-20">{{ $program->name }}</h3>
                        <p class="mb-25">{{ $program->description }}</p>
            ...
            <div class="row">
                <div class="col-lg-6 mb-50">
                    <div class="bd-program-details-widget-content theme-bg-6 wow fadeInLeft" data-wow-duration="1s"
                        ...
                        <p class="mb-25">As a result, the child should have a reasonable amount of freedom to do as
                            they
                            please, while at the same time being wholly immersed in an environment which stimulates
                            their
                            ...
                            will love it.</p>
                        <p class="mb-25">
                            Please take a moment to read this website, and I’m sure that you will come to agree that
                            there
                ...
                <div class="col-lg-6 mb-50">
                    <div class="bd-program-details-slider p-relative wow fadeInRight" data-wow-duration="1s"
                        data-wow-delay=".3s">
                        <div class="bd-program-details-slider-thumb p-relative">
                            <img src="{{ asset('frontend') }}/assets/img/program/details-1.jpg" alt="img not found!">
            ...
            <div class="row">
                <div class="col-lg-6 mb-50">
                    <div class="bd-program-details-slider p-relative wow fadeInLeft" data-wow-duration="1s"
                        data-wow-delay=".3s">
                        <div class="bd-program-details-slider-thumb p-relative">
                            <img src="{{ asset('frontend') }}/assets/img/program/details-2.jpg" alt="img not found!">
                            <div class="panel wow"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-50">
                    <div class="bd-program-details-widget-content theme-bg-6 wow fadeInRight" data-wow-duration="1s"
                        data-wow-delay=".3s">
                        <h3 class="bd-program-details-widget-title mb-20">More Information</h3>
                        <p class="mb-25">The past thirteen years have been memorable for the free kinder garten
                            movement
                            in
                            the United States. Previous to that time, the work was largely private, experimental.</p>
                        <div class="bd-program-details-list">
                            <ul>
    ...
    <section>
        <div class="container">
            <div class="bd-joining-area radius-24 fix pt-100 pb-95 wow fadeInUp" data-wow-duration="1s"
                data-wow-delay=".3s">
                <!-- joiniong bg -->
                <div class="bd-joining-bg" data-background="{{ asset('frontend') }}/assets/img/bg/joining-area.png"></div>
                <!-- joining bg overlay -->
                        ...
                        <div class="col-md-8">
                            <div class="bd-joining-content text-center">
                                <div class="bd-section-title-wrapper is-white mb-45">
                                    ...
                                    <p>Kindedo believes that good questions drive good answers. Whether it's a query<br>
                                        about
                ...
                <div class="col-12">
                    <div class="bd-program-active swiper-container wow fadeInUp" data-wow-duration="1s"
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="bd-program clr-4 mb-5">
                                        ...
                                        <div class="bd-program-content mb-40">
                                            <h3 class="bd-program-title"><a href="{{ route('front.program.details', $item->slug) }}"
                                                    class="hover-clr-4">{{ $item->name }}</a>
                                            </h3>
                                            <p>{{ $item->excerpt }}</p>
                                        </div>
                            ...
                            {{-- <div class="swiper-slide">
                                <div class="bd-program clr-4 mb-5">
                                    <div class="bd-program-thumb-wrapper">
                                        <a href="program-details.html">
                                            <div class="bd-program-thumb">
                                                <img src="{{ asset('frontend') }}/assets/img/program/home-program-5.jpg"
                                                    alt="Image not found">
                                            </div>
                                        </a>
                                        <div class="bd-program-shape">
                                    ...
                                    <div class="bd-program-content mb-40">
                                        <h3 class="bd-program-title"><a href="program-details.html"
                                                class="hover-clr-4">Nursery</a>
                                        </h3>
                                        <p>With connection with local licensed child care providers and other local.</p>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="bd-program clr-5 mb-5">
                                    <div class="bd-program-thumb-wrapper">
                                        <a href="program-details.html">
                                            <div class="bd-program-thumb">
                                                <img src="{{ asset('frontend') }}/assets/img/program/home-program-4.jpg"
                                                    alt="Image not found">
                                            </div>
                                        </a>
                                        <div class="bd-program-shape">
                            ...
                            <div class="swiper-slide">
                                <div class="bd-program clr-6 mb-5">
                                    <div class="bd-program-thumb-wrapper">
                                        <a href="program-details.html">
                                            <div class="bd-program-thumb">
                                                <img src="{{ asset('frontend') }}/assets/img/program/home-program-1.jpg"
                                                    alt="Image not found">
                                            </div>
                                        </a>
                                        <div class="bd-program-shape">
