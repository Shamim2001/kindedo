<div>
    <x-breadcrumb title="Our Facilities" />
                ...
                @foreach ($facilities as $key => $facility)
                    <div class="row">
                        @if ($key % 2 == 0)
                            <div class="col-lg-6 mb-90">
                                <div class="bd-program-details-slider p-relative wow fadeInLeft" data-wow-duration="1s"
                                    ...
                                    <div class="bd-program-details-slider-thumb p-relative">
                                        <img src="{{ getAssetUrl($facility->image, 'uploads/promos') }}"
                                            alt="{{ $facility->title }}">
                            ...
                            <div class="col-lg-6 mb-90">
                                <div class="bd-program-details-widget-content theme-bg-6 wow fadeInRight"
                                    data-wow-duration="1s" data-wow-delay=".3s">
                                    <h3 class="bd-program-details-widget-title mb-20">{{ $facility->title }}</h3>
                                    <p class="mb-25">{!! $facility->description !!}</p>
                                </div>
                            </div>
                        @else
                            <div class="col-lg-6 mb-90 order-lg-2">
                                <div class="bd-program-details-slider p-relative wow fadeInLeft" data-wow-duration="1s"
                                    data-wow-delay=".3s">
                                    <div class="bd-program-details-slider-thumb p-relative">
                                        <img src="{{ getAssetUrl($facility->image, 'uploads/promos') }}"
                            ...
                            <div class="col-lg-6 mb-90 order-lg-1">
                                <div class="bd-program-details-widget-content theme-bg-6 wow fadeInRight"
                                    data-wow-duration="1s" data-wow-delay=".3s">
                                    <h3 class="bd-program-details-widget-title mb-20">{{ $facility->title }}</h3>
                                    <p class="mb-25">{!! $facility->description !!}</p>
