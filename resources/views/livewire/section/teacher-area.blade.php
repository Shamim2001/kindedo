...
<section class="bd-teacher-area-2 theme-bg">
    <div class="container">
        <div class="bd-teacher-bg-wrapper pt-120 pb-120 p-relative">
            <div class="bd-teacher-bg d-none d-xl-block" data-background="{{ asset('frontend') }}/assets/img/bg/teacher-bg.jpg"></div>
                ...
                <div class="col-12">
                    ...
                    <div class="bd-teacher-wrapper">
                                        ...
                                        <div class="bd-teacher-thumb-wrapper-2 mb-20 p-relative">
                                            <a href="teacher-details.html">
                                                <div class="bd-teacher-thumb-2">
                                                    <img src="{{ getAssetUrl($teacher->photo, 'teachers') }}" alt="Image not found">
                                                </div>
                                            </a>
                                        ...
                                        <div class="bd-teacher-content-wrapper-2">
                                            <div class="bd-teacher-content-2 text-center">
                                                <h4 class="bd-teacher-title-2 mb-5"><a
                                                        href="teacher-details.html">{{ $teacher->name }}</a>
                                                </h4>
                                                <span class="bd-teacher-des is-white text-capitalize">{{ $teacher->role }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bd-teacher-view-btn p-relative z-index-1 text-center mt-10">
                            <a href="{{ route('front.teacher.index') }}">View Our All Teacher</a>
                        </div>
                    </div>
                    @endif
                </div>
