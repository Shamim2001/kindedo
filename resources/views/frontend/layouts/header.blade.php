                                ...
                                <ul>
                                    ...
                                    <li class="has-dropdown ">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="{{ route('front.message.management') }}">Message From
                                                    Management</a>
                                            </li>
                                            ...
                                            <li><a href="{{ route('front.administrative.team') }}">Administrative
                                                    Team</a></li>
                                            <li><a href="{{ route('front.procedure.policies') }}">Procedures and
                                                    Policies</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="has-dropdown has-mega-menu">
                                        ...
                                        <ul class="mega-menu mega-menu-2">
                                            <li>
                                                <a href="javascript:void(0);" class="d-lg-none">Notice</a>
                                                <ul>
                                                    <li> <a href="{{ route('front.academic.calender') }}" class="mega-program">
                                            ...
                                            <li class="test">
                                                <a href="javascript:void(0);" class="d-lg-none">Promo</a>
                                                <ul>
                                                    <li>
                                                        <div class="mega-menu-2-inner-thumb p-relative">
                                                            ...
                                                            <div class="mega-menu-2-inner-thumb-content">
                                                                ...
                                                                <div class="mega-menu-2-inner-thumb-btn mb-25">
                                                                    <a href="programs.html" class="mega-btn">View
                                                                        More</a>
                                                                </div>
                                                            </div>
                                                        </div>
